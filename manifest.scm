...
(define guile-tailify
  (let ((commit "8147422415611358cc18f4f2ee9794fb8c01fab1")
        (revision "1"))
    (package
     (inherit guile-next)
     (version (git-version "3.0.8" revision commit))
     (source
      (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "1ysnplc0qi3a6kvzr2n6fv6rr4d537k7ljs9f9f3p6rngcgifnsv")))))))
